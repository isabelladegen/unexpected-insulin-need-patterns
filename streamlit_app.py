...
def main():
    ...
    *Scan QR Code to open page on your device:*
    ...
    # Main body
    st.title("Beyond Expected Patterns in Type 1 Diabetes")
    st.markdown("*Isabella Degen | Kate Robson Brown | Henry W. J. Reev  e | Zahraa S. Abdallah*")
    st.markdown("[Read the full paper](https://dx.doi.org/10.2196/44384)")
